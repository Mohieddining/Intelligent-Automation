...
class State:
    ...
    The class is also a dataclass that simplifies the creation of classes. So
    ...
    def contains(self, variable: str) -> bool:
        ...
        if self.state.__contains__(variable):
            return True
        else:
            return False
    ...
    def get(self, variable: str) -> Any:
        ...
        if self.contains(variable):
            ...
            raise NotInStateException("The key you are looking for is not in the state!")
    ...
    def next(self, **kwargs) -> State:
        ...
        #hanges = {key: value for key, value in kwargs.items()}
